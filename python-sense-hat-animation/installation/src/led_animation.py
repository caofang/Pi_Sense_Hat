...
if __name__ == '__main__':
    ...
    while True:
        for x in range(5):
            square(image, [0, 0], [7, 0], [7, 7], [0, 7], [randint(0, 255), randint(0, 255), randint(0, 255)], .05)
            square(image, [1, 1], [6, 1], [6, 6], [1, 6], [randint(0, 255), randint(0, 255), randint(0, 255)], .05)
            square(image, [2, 2], [5, 2], [5, 5], [2, 5], [randint(0, 255), randint(0, 255), randint(0, 255)], .05)
            square(image, [3, 3], [4, 3], [4, 4], [3, 4], [randint(0, 255), randint(0, 255), randint(0, 255)], .05)
